...
function run_release() {
  docker run -w /go/src/github.com/oleewere/go-solr-client -e GITHUB_TOKEN=$GITHUB_TOKEN --rm -v $AMBARICTL_ROOT_DIR/vendor/:/go/src/ -v $AMBARICTL_ROOT_DIR:/go/src/github.com/oleewere/go-solr-client bepsays/ci-goreleaser:latest goreleaser --debug --rm-dist
}

function build_only() {
  docker run -w /go/src/github.com/oleewere/go-solr-client -e GITHUB_TOKEN=$GITHUB_TOKEN --rm -v $AMBARICTL_ROOT_DIR/vendor/:/go/src/ -v $AMBARICTL_ROOT_DIR:/go/src/github.com/oleewere/go-solr-client bepsays/ci-goreleaser:latest goreleaser --snapshot --debug --rm-dist --skip-publish
}
